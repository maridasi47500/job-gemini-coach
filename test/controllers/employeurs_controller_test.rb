...
class EmployeursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employeur" do
    assert_difference("Employeur.count") do
      post employeurs_url, params: { employeur: { employeur_type_id: @employeur.employeur_type_id, name: @employeur.name, secteur_id: @employeur.secteur_id } }
    end
  ...
  test "should update employeur" do
    patch employeur_url(@employeur), params: { employeur: { employeur_type_id: @employeur.employeur_type_id, name: @employeur.name, secteur_id: @employeur.secteur_id } }
